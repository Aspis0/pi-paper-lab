...
<!-- pi-paper-lab superscript bibliography XSL v1 | generated from IEEE2006OfficeOnline.xsl | wraps the Citation template body in <sup> | see scripts/build-superscript-xsl.mjs -->
      ...
      <xsl:when test="b:StyleNameLocalized">
        <xsl:choose>
          <xsl:when test="b:StyleNameLocalized/b:Lcid='1033'">
            <xsl:text>IEEE Superscript</xsl:text>
          </xsl:when>
